...
const RecentActivity = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  (props, ref) => {
    const { user } = useAuth();
    ...
    return (
      <Card ref={ref} variant="glass" className="animate-fade-in" style={{ animationDelay: "0.2s" }} {...props}>
